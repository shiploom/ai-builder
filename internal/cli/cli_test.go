...
func TestTableCoversAllCommands(t *testing.T) {
	...
	for i, name := range want {
		...
		wantWired := name == "validate" || name == "run" || name == "status" || name == "approvals" || name == "lock" || name == "verify" || name == "trace" || name == "approve" || name == "budget" || name == "resume" || name == "audit" || name == "characterize"
