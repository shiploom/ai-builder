...
{"adapterTargets": ["auto"], "budgets": {"spendUSD": 25.0, "tokens": 800000, "wallClockH": 8.0}, "coreVersion": "1.1.0", "harness": "auto", "mcpRegistry": "./.shiploom/mcp-registry.json", "policyPack": "default", "stack": null, "workflow": "greenfield-full-lite"}
EOF
