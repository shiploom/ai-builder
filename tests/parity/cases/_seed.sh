...
{"artifacts": {}, "budgets": {"spendUSD": {"limit": 25.0, "used": 0.0}, "tokens": {"limit": 800000, "used": 0}}, "checkpoints": [], "coreVersion": "$CORE_VERSION", "gates": {}, "initializedAt": "2026-01-01T00:00:00Z", "retries": {}, "steps": {}, "workflow": "$1", "workflowVersion": "1.0.0"}
EOF
  printf '# seed idea\n' > seed/idea.md
}
